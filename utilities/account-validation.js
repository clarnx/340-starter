...
validate.updateAccountRules = () => {
  return [
    ...
    // valid email is required and cannot already exist in the database (unless it's the same account)
    body("account_email")
      .trim()
      .isEmail()
      .normalizeEmail()
...
validate.passwordRules = () => {
  return [
    ...
    body("account_password")
      ...
      .withMessage(
        "Password does not meet requirements. Must be at least 12 characters with 1 capital letter, 1 number, and 1 special character."
      ),
  ];
};
